...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application API",
				"This project is developed by Ankit Gupta", "1.0", "Terms of Service",
				new Contact("Ankit", "https://www.linkedin.com/in/ankiit-gupta/", "workwithankitgupta@gmail.com"),
